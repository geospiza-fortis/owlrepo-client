...
ORDER BY search_item_timestamp DESC
LIMIT 200`,
      chart: { type: "scatter", x: "search_item_timestamp", y: "mean", color: "search_item" },
    },
    {
...
LIMIT 25`,
      chart: {
        type: "whisker", x: "search_item", y: "median",
        lowerfence: "lowerfence", q1: "q1", median: "median", q3: "q3", upperfence: "upperfence",
        color: null,
      },
    },
    {
...
LIMIT 25`,
      chart: { type: "scatter", x: "search_item_timestamp", y: "mean", color: null },
    },
  ];
