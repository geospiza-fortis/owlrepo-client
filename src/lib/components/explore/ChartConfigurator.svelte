<script>
  ...
  let {
    columns = [],
    chartConfig = $bindable({ type: "scatter", x: null, y: null, color: null }),
    visible = true,
  } = $props();
